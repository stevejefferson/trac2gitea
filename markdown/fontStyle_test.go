...
func TestTripleSingleQuoteBold(t *testing.T) {
	...
	conversion := converter.Convert(context, leadingText+"'''"+highlightedText+"'''"+trailingText)
...
func TestUnderline(t *testing.T) {
	...
	conversion := converter.Convert(context, leadingText+"__"+highlightedText+"__"+trailingText)
	assertEquals(t, conversion, leadingText+"*"+highlightedText+"*"+trailingText)
}
